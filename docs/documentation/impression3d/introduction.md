...
<figure markdown>
  ![Temps de séchage recommandé](assets/images/temperature-impression3d.png){ width="600" }
...
<figure markdown>
  ![Les grandes étapes de l'impression 3D](assets/images/etape-impression-3d.png){ width="600" }
...
<figure markdown>
  ![Étape de découpe dans le logiciel](assets/images/etape-slicer-impression-3d.png){ width="600" }
...
<figure markdown>
  ![Une vue macro de trois impressions 3D](assets/images/epaisseur-impression-3d.jpeg){ width="600" }
...
<figure markdown>
  ![Hauteur de la couche](assets/images/hauteur-couche.png){ width="600" }
...
<figure markdown>
  ![Différents remplissage d'une impression 3D](assets/images/remplissage.png){ width="600" }
...
<figure markdown>
  ![Des pièces imprimées en 3D avec et sans support](assets/images/support.png){ width="600" }
...
<figure markdown>
  ![Pièce dans le logiciel de découpe avec un brim](assets/images/brim-impression3d.png){ width="600" }
